...
<body>
    ...
    <div id="maindiv" class="d-flex flex-column align-items-center justify-content-center">
        <form method="post" action="?action=finishattributeadd">
            <div class="form-group">
              <label for="name">Category name</label>
              <input type="text" name="name" class="form-control" id="name"  readonly value="<%= cb.getName() %>">
            </div>
            <div class="form-group">
              <label for="attrname">Attribute Name</label>
              <input type="text" name="attrname" class="form-control" id="attrname" placeholder="Name">
            </div>
            <div class="form-group">
              <label for="attrvalue">Attribute Value</label>
              <input type="text" name="attrvalue" class="form-control" id="attrvalue" placeholder="Value">
            </div>
