...
CREATE TABLE `slika` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_slika_program_idx` (`program_id`),
  CONSTRAINT `fk_slika_program` FOREIGN KEY (`program_id`) REFERENCES `program` (`id`)
...
INSERT INTO `slika` VALUES (1,'https://cdn.pixabay.com/photo/2015/03/10/17/23/youtube-667451_1280.png',1);
