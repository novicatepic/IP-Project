...
<body>
    ...
    <form method="post" action="start.jsp" class="text-center">
        <div class="form-group">
            <label for="username">Username</label>
            <input required="required" type="text" name="username" class="text-center form-control" id="username" placeholder="Username">
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">Password</label>
            <input required="required" type="password" name="password" class="text-center form-control" id="exampleInputPassword1" placeholder="Password">
        </div>
